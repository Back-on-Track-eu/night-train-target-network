...
RANGE_COLUMNS: dict[str, str] = {
    ...
    "train_km_per_year": "train_km_per_year",
    "available_place_km_per_year": "available_place_km_per_year",
    "sold_place_km_per_year": "sold_place_km_per_year",
    ...
    "shift_other_trips_per_year": "shift_other_trips_per_year",
    "shift_other_trip_km_per_year": "shift_other_trip_km_per_year",
