...
def summary_row_to_dict(row: dict) -> dict:
    ...
    return {
        ...
        "net_eur_per_year": _to_float(row["net_eur_per_year"]),
        "subsidy_eur_per_year": _to_float(row["subsidy_eur_per_year"]),
        "services_revenue_eur": _to_float(row["services_revenue_eur"]),
        "catering_contribution_eur": _to_float(row["catering_contribution_eur"]),
        "operating_days_per_year": row["operating_days_per_year"],
        "departures_per_year": row["departures_per_year"],
        "trainsets_physical": row["trainsets_physical"],
        "train_km_per_year": _to_float(row["train_km_per_year"]),
        "available_place_km_per_year": _to_float(row["available_place_km_per_year"]),
        "sold_place_km_per_year": _to_float(row["sold_place_km_per_year"]),
        "passengers_per_year": _to_float(row["passengers_per_year"]),
        ...
        "shift_other_trips_per_year": _to_float(row["shift_other_trips_per_year"]),
        "shift_other_trip_km_per_year": _to_float(row["shift_other_trip_km_per_year"]),
