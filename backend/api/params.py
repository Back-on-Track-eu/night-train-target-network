...
def get_stop_infrastructures():
    ...
    def _field(stop_id, field_name, value):
        ...
        return {
            ...
            } if entry and entry.source else None,
    ...
    stops = [
        {
            ...
            "stop_charge_eur": _field(s.stop_id, "stop_charge_eur", float(s.stop_charge_eur)),
        }
...
def get_track_infrastructures():
    ...
    for t in tracks.all().values():
        ...
        result.append({
            "country_code":          cc,
            "tac_eur_train_km":      _field(cc, "tac_eur_train_km",       float(t.tac_eur_train_km)),
            "energy_price_eur_kwh":  _field(cc, "energy_price_eur_kwh",   float(t.energy_price_eur_kwh)),
            "parking_eur_day":       _field(cc, "parking_eur_day",        float(t.parking_eur_day)),
            ...
            "min_boarding_time_min": _field(cc, "min_boarding_time_min",  t.min_boarding_time_min),
            "min_alighting_time_min":_field(cc, "min_alighting_time_min", t.min_alighting_time_min),
            "buffer_quota_per":      _field(cc, "buffer_quota_per",       float(t.buffer_quota_per)),
        })
