from models.route_evaluation_model.routing.rail_router import (
    RailRouter, Stop, CompositionParams, InfraParams
)
import logging
import time
...
# --- stops ---
stops = [
    Stop(stop_id='hamburg_hbf', name='Hamburg Hbf',
         lat=53.5535, lon=10.0045, country_code='DE', stop_type='boarding'),
    Stop(stop_id='paris_est',   name='Paris Est',
         lat=48.8768, lon=2.3588,  country_code='FR', stop_type='both'),
    Stop(stop_id='wien_hbf',    name='Wien Hbf',
         lat=48.1853, lon=16.3756, country_code='AT', stop_type='alighting'),
]
