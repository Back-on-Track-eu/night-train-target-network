...
class TestVersionIsolation:
    ...
    def test_loader_pinned_to_whatif_returns_old_snapshot(self, loader, whatif_scenario):
...
class TestParamProvenance:
    ...
    def test_stop_null_charge_resolves_from_global_default(self, loader, db_cur, base_scenario):
